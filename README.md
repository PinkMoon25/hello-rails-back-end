...
**Hello Rails Back end** is a simple backend Api created with rails to serve random greeting messages to the front end.
[link to the front end repo](https://github.com/PinkMoon25/hello-react-front-end)
...
```sh
  cd my-folder
  git clone git@github.com:PinkMoon25/hello-rails-back-end.git
```
